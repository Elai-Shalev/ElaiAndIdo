...
//			System.out.println("Enter Value");
		...
		do {
			...
			AVL.AVLTree.print2DUtil(T2.getRoot(),1);
			System.out.println("first insert cost: " + ins1);
		...
		AVL.AVLTree AVL.Tester = new AVL.AVLTree();
		AVL.Tester.insert(3, "3");

		System.out.println("it cost:" + T1.join(AVL.Tester.getRoot(), T2));
		System.out.println("new tree is: \n\n");
		AVL.AVLTree.print2DUtil(T1.getRoot(),1);
